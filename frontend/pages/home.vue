          ...
          >
            ...
            >
              ...
              >
                <DialogTitle
                    as="h3"
                    class="text-lg font-medium leading-6 text-gray-900 py-1"
                >
                  {{ voteTitle }}
                </DialogTitle>
              </DialogTitle>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center py-2 space-x-1">
                  ...
                  <span class="text-sm text-gray-400">{{ usernameVote }}</span>
                </div>
                <p class="text-sm text-gray-400">{{ dayjs(timeVote) }}</p>
