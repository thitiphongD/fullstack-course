<template>
            ...
            >
              ...
              <div class="mt-2">
                <form @submit="onSubmit">
                  <div class="mb-6">
                    <label for="name" class="block mb-2 text-lg font-medium text-gray-500">Name<span
                        class="text-red-700">*</span></label>
                    <input type="text" v-model="namePost" class="border text-gray-900 text-sm rounded-lg w-full p-2.5"
                           placeholder="Name">
                  </div>
                  <div class="mb-6">
                    <label for="description" class="block mb-2 text-lg font-medium text-gray-500">Description</label>
                    <textarea name="description" v-model="descriptionPost" rows="3"
                              class="w-full h-48 rounded-md p-2.5 border text-gray-700"></textarea>
  ...
  <div class="h-screen lg:bg-blue-400">
    ...
    <div class="px-32 py-10">
      <p class="text-3xl font-bold">All Posts <span>(0)</span></p>
      <div class="py-5">
        ...
        >
          <div class="bg-white row-span-1 col-span-1 rounded-md h-40 p-3 cursor-pointer"  v-for="(item, i) in items" :key="i">
            <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center py-2 space-x-1">
                ...
                <span class="text-sm text-gray-400">{{ item.user.username }}</span>
              </div>
...
import {
  Menu, MenuButton, MenuItems, MenuItem, TransitionRoot,
  TransitionChild,
  Dialog,
  DialogPanel,
  DialogTitle,
...
onMounted(()=> {
  axios.get('https://vote-api.mhalong.com/posts?limit=30&page=1&q=&order_by=posts.created_at+DESC',{
    headers : {
